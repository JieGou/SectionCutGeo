...
namespace SectionCutGeo
{
    ...
    /// </summary>
    internal class JtObjCounter : Dictionary<string, int>
    {
        /// <summary>
        ...
        {
            string key = null == obj ? "null" : obj.GetType().Name;
    ...
    public class Command : IExternalCommand
    {
        ...
        /// </summary>
        private const double _eps = 1.0e-6;

        /// <summary>
        /// User instructions for running this external command
        /// </summary>
        private const string _instructions = "Please launch this "
        ...
        /// </summary>
        private static bool IsLineInPlane(Line line, Plane plane)
        {
            ...
            Debug.Assert(0 <= d0, "expected non-negative distance");
            Debug.Assert(0 <= d1, "expected non-negative distance");
        ...
        /// in the given plane
        /// </summary>
        private static void GetCurvesInPlane(List<Curve> curves, JtObjCounter geoCounter, Plane plane, GeometryElement geo)
        {
            ...
            if (null != geo)
            {
                foreach (GeometryObject obj in geo)
                {
                    ...
                    else
                    {
                        ...
                        if (null != inst)
                        {
                            GetCurvesInPlane(curves, geoCounter, plane, inst.GetInstanceGeometry());
                        }
                        else
                        {
                            Debug.Assert(false, "unsupported geometry object " + obj.GetType().Name);
                        }
                    }
                }
            }
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            Parameter p = section_view.get_Parameter(BuiltInParameter.VIEWER_BOUND_FAR_CLIPPING);

            if (/*ViewType.Section != section_view.ViewType ||*/ ViewDetailLevel.Fine != section_view.DetailLevel /*|| 1 != p.AsInteger()*/)
            {
            ...
            Plane plane2 = Plane.CreateByNormalAndOrigin(section_view.ViewDirection, section_view.Origin);
